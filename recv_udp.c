...
int main(int argc, char *argv[])
{
  ...
  fflush(stdout); //use fflush to be sure that printsin() will be print before something else will happen
  ...
  for(;;) {
    ...
    fflush(stdout);//use fflush to be sure that printf() will be print before something else will happen
  }
